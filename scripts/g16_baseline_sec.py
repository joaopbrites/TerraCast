...
print('file.variables.keys():',file.variables.keys())
...
if (variable == 'HT'):  
    ...
    data[data == min(data[0])] = np.nan
# elif (variable == 'PSD'): 
elif (variable == 'CPS'): # Aparentemente, mudou de PSD para CPS
    # CPSF
    cmap = 'jet'
    vmin = 0
    vmax = 100
    ...
    print('não entou em nenhum dos trechos')
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# Plot configuration
plot_config = {
...
if (variable == 'Phase'): 
	...
	my_legend = plt.imread(str(get_asset_path("PHASE_legend.png")))
...
# O arquivo não existe, dá erro e para
