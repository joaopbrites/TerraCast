...
#------------------------------------------------------------------------------------------------------
print("\n\nprocess_msg_bands_rgb_fdk.py", end=' ')
# Exemplo de chamada:
# Miniconda3/envs/showcast/bin/python Scripts/process_msg_bands_rgb_fdk.py /usr/local/bin/SHOWCast_v_2_5_1/Scripts/process_msg_bands_rgb_fdk.py /dados/fazzt/MSG-0degree/IMG-3h/H-000-MSG3__-MSG3________-_________-EPI______-202405031400-__ -63.0 -35.0 -35.0 -10.0 8 /usr/local/bin/SHOWCast_v_2_5_1/Output/ /usr/local/bin/SHOWCast_v_2_5_1/HTML/Output/
#
# python3 process_msg_bands_rgb_fdk.py dados/H-000-MSG3__-MSG3________-_________-EPI______-202405231900-__ -63.0 -35.0 -35.0 -10.0 8 output/ output/

#------------------------------------------------------------------------------------------------------
# Required modules
#--------------------------------
import logging
from utils import sys                                                   # Import the "system specific parameters and functions" module
...
print('Script process_msg_bands_rgb_fdk.py started.')
start = t.time()
...
# FixMe: The use of PPP_CONFIG_DIR is deprecated and will be removed in version 1.9! Please use PYORBITAL_CONFIG_PATH if you need a custom config path for pyorbital!
...
if result is None:
    raise Exception(f"O arquivo processado não tem nome no formato requerido ({path})")
