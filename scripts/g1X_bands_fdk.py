...
# Exemplo de chamada:
# python g1X_bands_fdk.py "/dados/fazzt/GOES-R-CMI-Imagery/Band03/OR_ABI-L2-CMIPF-M6C03_G16_s20241101800203_e20241101809511_c20241101809566-134602_0.nc" -54.0 -28.0 -43.0 -18.0 8 /usr/local/bin/SHOWCast_v_2_5_1/Output/ /usr/local/bin/SHOWCast_v_2_5_1/HTML/Output/ 00,10,20,30,40,50
...
def run(CONFIG, product):
    ...
    intervals = product['interval'].split(',')        # Read the string from the parameters
    ...
    f = math.ceil(float(product['resolution'] / band_resolution_km))
    ...
    "file_name_id_1": satellite,  "file_name_id_2": productName
    }
    #---------------------------------------------------------------------------------------------
    #---------------------------------------------------------------------------------------------
    ...
    #ax.outline_patch.set_visible(False) #erro: AttributeError: 'GeoAxes' object has no attribute 'outline_patch'
