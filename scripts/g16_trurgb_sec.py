...
file = []
for filename in sorted(glob.glob(path_ch02+'Band02-0.5km/OR_ABI-L2-CMIPF-M*C02_G1*.nc')):
    file.append(filename)
    
# Seek for a GOES-16 file (same time) in the directory
# file é a lista de arquivos cujo nome tem o padrão acima
# scan_start é uma data, ex.: 20241101800203
...
my_legend = plt.imread(str(get_asset_path("TRUECOLOR_legend.png")))
