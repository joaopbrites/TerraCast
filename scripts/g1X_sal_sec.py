...
#ax.stock_img()
fname = os.path.join(str(get_asset_path('world.topo.bathy.200408.3x5400x2700.jpg')))
...
land_geom = unary_union(list(shpreader.Reader(str(get_asset_path("ne_10m_coastline.shp"))).geometries()))
land = prep(land_geom)
...
my_legend = plt.imread(str(get_asset_path("SAL_legend.png")))
