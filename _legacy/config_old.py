...
# Modificado por Bruno Schneider, ABR/2024, uma alternativa ao showcast_config.py
...
#######################################################################################################
def Products(CONFIG:dict) -> list[dict]:
    resultado = []
    p = {}
...
def ProcessProduct(CONFIG, product):
    ...
    inputFileNames = sorted(glob.glob(product['input'] + product['filename pattern'],recursive=True))
