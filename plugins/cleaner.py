...
ingest_dir = '/dados/fazzt/'       # Linux Example - Change it according to your GNC-A Station 
...
def call_cleaner(sc): 
    ...
    if (delete_historical_ingest == True):
        ...
        # Deleting files older than "x" days + "x" hours inside the "/dados/fazzt" folder structure  
